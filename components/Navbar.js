			...
			<nav className="fixed bg-gray-200 dark:bg-gray-900 flex justify-center items-center flex-wrap py-3 px-10 z-50 h-20 w-full">
				<div className="inline-flex w-1/3">
					<Link href="/">
						<a className="inline-flex items-center p-2">
							<h1 className="text-xl font-semibold tracking-widest">Brandon McCray</h1>
						</a>
					</Link>
				</div>
				<div className="w-1/3 inline-flex justify-center items-center w-full">
					<Link href="/">
						<a className="px-3 py-2 mx-2 rounded hover:bg-slate-300 dark:hover:bg-slate-600 transistions-all duration-300">
							Home
						</a>
					</Link>
					<Link href="/about">
				...
				<div className="inline-flex justify-end w-1/3">
					<button
						...
						type="button"
						className="h-10 w-10 order-2 md:order-3 absolute left-2/4 transform -translate-x-2/4 lg:transform-none md:relative md:left-0"
